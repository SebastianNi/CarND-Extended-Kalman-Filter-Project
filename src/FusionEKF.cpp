...
FusionEKF::FusionEKF() {
  ...
  */
  ...
  // Initialize the measurement matrix for measurement update
  H_laser_ << 1, 0, 0, 0,
              0, 1, 0, 0;
...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  // Initiate noise_ax and noise_ay for the Q matrix
  float noise_ax = 9;
  float noise_ay = 9;
